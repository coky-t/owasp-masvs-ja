...
Mobile Application Security Verification Standard (MASVS) 0.9.2 へようこそ。MASVS は iOS および Android 上でセキュアなモバイルアプリケーションを設計、開発、テストするときに必要となるセキュリティ要件のフレームワークを確立するためのコミュニティの取組みです。
